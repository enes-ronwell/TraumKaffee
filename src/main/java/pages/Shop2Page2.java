...
public class Shop2Page2 {
    ...
    private final By ChocolateColombiaCoffeeTitle = By.cssSelector(".mb-16 > div:nth-of-type(1) > div:nth-of-type(1) div:nth-of-type(3) h3:nth-of-type(1)");
    private final By ChocolateColombiaCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(3) p:nth-of-type(2)");
    private final By AlmondColombiaCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(4) h3:nth-of-type(1)");
    private final By AlmondColombiaCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(4) p:nth-of-type(2)");
    private final By TraumBlendCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(5) h3:nth-of-type(1)");
    private final By TraumBlendCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(5) span:nth-of-type(1) p:nth-of-type(1)");
    private final By TraumKickstartCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(6) h3:nth-of-type(1)");
    private final By TraumKickstartCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(6) span:nth-of-type(1) p:nth-of-type(1)");
    private final By ElSalvadorApanecaCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(7) h3:nth-of-type(1)");
    private final By ElSalvadorApanecaCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(7) span:nth-of-type(1) p:nth-of-type(1)");
    private final By HondurasOpalcaCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(8) h3:nth-of-type(1)");
    private final By HondurasOpalcaCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(8) span:nth-of-type(1) p:nth-of-type(1)");
    ...
    private final By TraumKickStartCapsuleCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(1) p:nth-of-type(2)");
    private final By KenyaCapsuleCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(2) > div:nth-of-type(2) div:nth-of-type(2) h3:nth-of-type(1)");
    private final By KenyaCapsuleCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(2) > div:nth-of-type(2) div:nth-of-type(2) p:nth-of-type(2)");
    ...
    private final By BurundiDripCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(9) h3:nth-of-type(1)");
    private final By BurundiDripCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(9) span:nth-of-type(1) p:nth-of-type(1)");
    private final By ElSalvadorApanecaDripCoffeeTitle = By.cssSelector(".mb-16 div:nth-of-type(10) h3:nth-of-type(1)");
    private final By ElSalvadorApanecaDripCoffeePrice = By.cssSelector(".mb-16 div:nth-of-type(10) span:nth-of-type(1) p:nth-of-type(1)");
    ...
    private final By NoItems = By.cssSelector("[width='100']");
