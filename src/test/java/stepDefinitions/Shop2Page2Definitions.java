...
public class Shop2Page2Definitions {
    ...
    public void userShouldSeeWholeBeanCoffeesButtonTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Capsules Coffees Button Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeCapsulesCoffeesButtonTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Drip Coffees Button Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeDripCoffeesButtonTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Whole Bean Coffees Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeWholeBeanCoffeesTitleOnShopTwoPageTwo(String arg0) {
    }
    ...
    public void userShouldSeeCapsulesCoffeesTitleOnShopTwoPageTwo(String arg0) {
    }
    ...
    public void userShouldSeeDripCoffeesTitleOnShopTwoPageTwo(String arg0) {
    }
    ...
    public void userShouldSeeChocolateColombiaCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Chocolate Colombia coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeChocolateColombiaCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Almond Colombia Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeAlmondColombiaCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Almond Colombia Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeAlmondColombiaCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Blend Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumBlendCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Blend Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumBlendCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Kickstart Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumKickstartCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Kickstart Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumKickstartCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see El Salvador Apaneca Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeElSalvadorApanecaCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see El Salvador Apaneca Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeElSalvadorApanecaCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Honduras Opalca Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeHondurasOpalcaCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Honduras Opalca Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeHondurasOpalcaCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Kick Start Capsule Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumKickStartCapsuleCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Kick Start Capsule Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumKickStartCapsuleCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Kenya Capsule Coffee Title :{string} on ShopTwo PageTwo")
    public void userShouldSeeKenyaCapsuleCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Kenya Capsule Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeKenyaCapsuleCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Gituro Kenya Capsule Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeGituroKenyaCapsuleCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Gituro Kenya Capsule Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeGituroKenyaCapsuleCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Chocolate Colombia Capsule Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeChocolateColombiaCapsuleCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Chocolate Colombia Capsule Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeChocolateColombiaCapsuleCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Blend Capsule Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumBlendCapsuleCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Traum Blend Capsule Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeTraumBlendCapsuleCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Burundi Drip Coffee Title : {string} on ShopTwo PageTwo")
    public void userShouldSeeBurundiDripCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Burundi Drip Coffee Price : {string} on ShopTwo PageTwo")
    public void userShouldSeeBurundiDripCoffeePriceOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see El Salvador Apaneca Drip Coffee Title :{string} on ShopTwo PageTwo")
    public void userShouldSeeElSalvadorApanecaDripCoffeeTitleOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see El Salvador Apaneca Drip Coffee Price :{string} on ShopTwo PageTwo")
    public void userShouldSeeElSalvadorApanecaDripCoffeePriceOnShopTwoPageTwo(String arg0) {
    }
    ...
    public void userShouldSeeBasketOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see No Items : {string} on ShopTwo PageTwo")
    public void userShouldSeeNoItemsOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see Complete Your Order : {string} on ShopTwo PageTwo")
    public void userShouldSeeCompleteYourOrderOnShopTwoPageTwo(String arg0) {
    }

    @Then("user should see AED : {string} on ShopTwo PageTwo")
    public void userShouldSeeAEDOnShopTwoPageTwo(String arg0) {
    }
}
