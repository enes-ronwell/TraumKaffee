...
Feature: Home Page
  ...
  Scenario: User should see Traum Kaffee Instagram Page when clicked the First Tweet’s Instagram Button in the Tweets Area on Home Page
    Given user on the Home Page
    When click Twits Area First Twit Instagram Icon on Home Page
    Then should see the Traum Kaffee Instagram Page

  @TwitsArea @Navigation @SecondTwit
  Scenario: User should see Traum Kaffee Twitter Page when clicked the Second Tweet’s Twitter Button in the Tweets Area on Home Page
    Given user on the Home Page
    When click Twits Area Second Twit Twitter Icon on Home Page
    Then should see the Traum Kaffee Twitter Page

  @TwitsArea @Navigation @ThirdTwit
  Scenario: User should see Traum Kaffee Twitter Page when clicked the Third Tweet’s Twitter Button in the Tweets Area on Home Page
    Given user on the Home Page
    When click Twits Area Third Twit Twitter Icon on Home Page
    Then should see the Traum Kaffee Twitter Page

  @TwitsArea @Navigation @FourthTwit
  Scenario: User should see Traum Kaffee Instagram Page when clicked the Fourh Tweet’s Instagram Button in the Tweets Area on Home Page
    Given user on the Home Page
    When click Twits Area Fourth Twit Instagram Icon on Home Page
    Then should see the Traum Kaffee Instagram Page

  @TwitsArea @Navigation @FifthTwit
  Scenario: User should see Traum Kaffee Instagram Page when clicked the Fifth Tweet’s Instagram Button in the Tweets Area on Home Page
    Given user on the Home Page
    When click Twits Area Fifth Twit Instagram Icon on Home Page
    Then should see the Traum Kaffee Instagram Page

  @TwitsArea @Navigation @SixthtTwit
  Scenario: User should see Traum Kaffee Twitter Page when clicked the Sixth Tweet’s Twitter Button in the Tweets Area on Home Page
    Given user on the Home Page
