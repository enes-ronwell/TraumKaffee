...
Feature: Whosale Page
  ...
  Scenario: Whosale Area Text and Component Control
    ...
    Then should see Partnership Perks Area Equipment Description: "We help to source the most suitable equipment for your service model according to your specific needs.With our extensive experience in café service contexts, we can advise you on a well-planned service layout and provide you with the necessary equipment." on Whosale Page
